...
export function activate(context: vscode.ExtensionContext) {
  ...
  context.subscriptions.push(
    vscode.languages.registerCodeLensProvider({ language: 'csharp', scheme: 'file' }, codeLensProvider)
  );

  context.subscriptions.push(
    vscode.commands.registerCommand('dotnet-test-explorer.showLog', () => {
      Logger.Show();
    })
  );

  context.subscriptions.push(
    vscode.commands.registerCommand('dotnet-test-explorer.stop', () => {
      Executor.stop();
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand('dotnet-test-explorer.refreshTestExplorer', () => {
      testDirectories.parseTestDirectories();
      dotnetTestExplorer.refreshTestExplorer();
    })
  );
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand('dotnet-test-explorer.runAllTests', () => {
      testCommands.runAllTests();
    })
  );

  context.subscriptions.push(
    vscode.commands.registerCommand('dotnet-test-explorer.runTest', (test: TestNode) => {
      testCommands.runTest(test);
    })
  );

  context.subscriptions.push(
    vscode.commands.registerCommand('dotnet-test-explorer.coverTest', (test: TestNode) => {
      testCommands.coverTest(test);
    })
  );

  context.subscriptions.push(
    vscode.commands.registerCommand('dotnet-test-explorer.gotoTest', (test: TestNode) => {
      gotoTest.go(test);
    })
  );

  context.subscriptions.push(
    vscode.commands.registerCommand('dotnet-test-explorer.debugTest', (test: TestNode) => {
      testCommands.debugTestByName(test.fqn, !test.isFolder);
    })
  );

  context.subscriptions.push(
    vscode.commands.registerCommand('dotnet-test-explorer.rerunLastCommand', (test: TestNode) => {
      testCommands.rerunLastCommand();
    })
  );

  context.subscriptions.push(
    vscode.commands.registerCommand('dotnet-test-explorer.leftClickTest', (test: TestNode) => {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand('dotnet-test-explorer.openPanel', () => {
