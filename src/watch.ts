...
export class Watch {
  private watchedDirectories: Array<string> = [];

  constructor(private readonly testCommands: TestCommands, private readonly testDirectories: TestDirectories) {
