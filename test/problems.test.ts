  ...
  test('One results with stacktrace', () => {
    const results = [
      GetTestResult(
        ...
        'Passed',
        'Some assert error',
        ' Bla bla bla  at XunitTests.InnerC.Get() in D:\\xunittests\\TestClass1.cs:line 43'
      )
    ];
  ...
  test('Two results with stacktrace in different files', () => {
    const results = [
      ...
      GetTestResult(
        '2',
        'Failed',
        'Another assert error',
        '  at XunitTests.InnerC.Get() in D:\\xunittests\\TestClass2.cs:line 43'
      )
    ];
  ...
  test('Two results with stacktrace in same file', () => {
    const results = [
      ...
      GetTestResult(
        ...
        'Failed',
        'Another assert error',
        '  at XunitTests.InnerC.Get() in D:\\xunittests\\TestClass1.cs:line 83'
      )
    ];
